    ...
    async with aiohttp.ClientSession() as session:
        async def binance_lastPrice():
            try:
                ...
                binance_lastPrice = 0
            return binance_lastPrice
        # print(await binance_lastPrice())

        async def qmall_lastPrice():
            try:
                ...
                qmall_lastPrice = 0
            return qmall_lastPrice
        # print(await binance_lastPrice())

        async def whitebit_lastPrice():
            try:
            ...
            return whitebit_lastPrice

        # print(await whitebit_lastPrice())

        async def huobi_lastPrice():
            try:
                ...
                huobi_lastPrice = 0
            return huobi_lastPrice
        # print(huobi_lastPrice)

        async def exmo_lastPrice():
            try:
                ...
                exmo_lastPrice = 0
            return exmo_lastPrice
        # print(await exmo_lastPrice())

        async def kucoin_lastPrice():
            try:
                ...
                kucoin_lastPrice = 0
            return kucoin_lastPrice
        # print(await kucoin_lastPrice())

        async def bybit_lastPrice():
            try:
                ...
                bybit_lastPrice = 0
            return bybit_lastPrice
        # print(await bybit_lastPrice())

        async def okx_lastPrice():
            try:
                ...
                okx_lastPrice = 0
            return okx_lastPrice
        # print(await okx_lastPrice())

        async def kuna_lastPrice():
            try:
                ...
                kuna_lastPrice = 0
            return kuna_lastPrice
        # print(await kuna_lastPrice())
        

        print('spot_time:',start - time.time())

        all_prices_array = {'kuna        ': await kuna_lastPrice(), 'okx           ': await okx_lastPrice(), 'bybit        ': await bybit_lastPrice(), 'kucoin     ': await kucoin_lastPrice(), 'binance   ': await binance_lastPrice(), 'qmall       ': await qmall_lastPrice(), 'whitebit  ': await whitebit_lastPrice(), 'exmo       ': await exmo_lastPrice(), 'huobi       ': await huobi_lastPrice()}
